...
public class BannerView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        int shape = array.getInt(R.styleable.BannerView_bvIndicatorShape, Shape.oval.ordinal());
        ...
        selectedIndicatorHeight = (int) array.getDimension(R.styleable.BannerView_bvSelectedIndicatorHeight, selectedIndicatorHeight);
        selectedIndicatorWidth = (int) array.getDimension(R.styleable.BannerView_bvSelectedIndicatorWidth, selectedIndicatorWidth);
        unSelectedIndicatorHeight = (int) array.getDimension(R.styleable.BannerView_bvUnSelectedIndicatorHeight, unSelectedIndicatorHeight);
        unSelectedIndicatorWidth = (int) array.getDimension(R.styleable.BannerView_bvUnSelectedIndicatorWidth, unSelectedIndicatorWidth);

        int position = array.getInt(R.styleable.BannerView_bvIndicatorPosition, Position.centerBottom.ordinal());
        for (Position position1 : Position.values()) {
            if (position == position1.ordinal()) {
                indicatorPosition = position1;
            }
        }
        indicatorSpace = (int) array.getDimension(R.styleable.BannerView_bvIndicatorSpace, indicatorSpace);
        indicatorMargin = (int) array.getDimension(R.styleable.BannerView_bvIndicatorMargin, indicatorMargin);
        autoPlayDuration = array.getInt(R.styleable.BannerView_bvAutoPlayDuration, autoPlayDuration);
        scrollDuration = array.getInt(R.styleable.BannerView_bvScrollDuration, scrollDuration);
        isAutoPlay = array.getBoolean(R.styleable.BannerView_bvIsAutoPlay, isAutoPlay);
    ...
    public void setViews(final List<View> views) {
        ...
        setIndicator(isShowIndicator);
    }

    public void setIndicator(boolean isShowIndicator) {
