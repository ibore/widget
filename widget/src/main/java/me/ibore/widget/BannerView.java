...
public class BannerView<T> extends FrameLayout {
    ...
    public interface ViewFactory<T> {
        View create(T t, int position, ViewGroup container);
    }

    public interface TitleAdapter<T> {
    ...
    private ViewPagerIndicatorView vIndicator;
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        vIndicator = new ViewPagerIndicatorView(context);
    ...
    public ViewPagerIndicatorView getIndicator() {
        return vIndicator;
    }
