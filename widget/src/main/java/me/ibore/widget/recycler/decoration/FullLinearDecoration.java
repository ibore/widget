...
public class FullLinearDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public FullLinearDecoration(@NonNull Context context,
                                int dividerSize,
     ...
     */
    public FullLinearDecoration(int dividerSize,
