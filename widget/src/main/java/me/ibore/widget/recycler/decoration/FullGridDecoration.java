...
public class FullGridDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public FullGridDecoration(@NonNull Context context,
                              int dividerSize,
     ...
     */
    public FullGridDecoration(int dividerSize,
