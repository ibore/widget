...
public class ViewPagerIndicatorView extends View {
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ViewPagerIndicatorView);
        mSelected_color = array.getColor(R.styleable.ViewPagerIndicatorView_vpiSelectedColor, 0xffffffff);
        mDefault_color = array.getColor(R.styleable.ViewPagerIndicatorView_vpiDefaultColor, 0xffcdcdcd);
        mRadius = array.getDimension(R.styleable.ViewPagerIndicatorView_vpiRadius, 20);//px
        mRadiusSelected = array.getDimension(R.styleable.ViewPagerIndicatorView_vpiRadiusSelected, mRadius);//px
        mLength = array.getDimension(R.styleable.ViewPagerIndicatorView_vpiLength, 2 * mRadius);//px
        mDistance = array.getDimension(R.styleable.ViewPagerIndicatorView_vpiDistance, 3 * mRadius);//px
        mDistanceType = array.getInteger(R.styleable.ViewPagerIndicatorView_vpiDistanceType, DistanceType.BY_RADIUS);
        mIndicatorType = array.getInteger(R.styleable.ViewPagerIndicatorView_vpiIndicatorType, IndicatorType.CIRCLE);
        mNum = array.getInteger(R.styleable.ViewPagerIndicatorView_vpiNum, 0);
        mAnimation = array.getBoolean(R.styleable.ViewPagerIndicatorView_vpiAnimation, true);
        array.recycle();
     ...
     * @param num
     */
    public ViewPagerIndicatorView setNum(int num) {
        mNum = num;
        invalidate();
        return this;
    }
     ...
     * @param indicatorType
     */
    public ViewPagerIndicatorView setType(int indicatorType) {
     ...
     * @param radius
     */
    public ViewPagerIndicatorView setRadius(float radius) {
        this.mRadius = radius;
        invalidate();
        return this;
    }
     ...
     * @param distance
     */
    public ViewPagerIndicatorView setDistance(float distance) {
     ...
     * @param mDistanceType
     */
    public ViewPagerIndicatorView setDistanceType(int mDistanceType) {
     ...
     * @return
     */
    public ViewPagerIndicatorView setViewPager(ViewPager viewPager) {
     ...
     * @return
     */
    public ViewPagerIndicatorView setViewPager(ViewPager viewpager, int CycleNumber) {
     ...
     * @return
     */
    public ViewPagerIndicatorView setViewPager(ViewPager viewPager, boolean isInfiniteCircle) {
        if(isInfiniteCircle){
     ...
     * @return
     */
    public ViewPagerIndicatorView setViewPager(ViewPager viewpager, int CycleNumber, boolean isInfiniteCircle) {
        mNum = CycleNumber;
