...
public class ImageStateHelper  {
    ...
    public ImageStateHelper(Context context, ImageView view, AttributeSet attrs) {
        mView = view;
    ...
    public ImageStateHelper setIconNormal(Drawable icon) {
    ...
    public ImageStateHelper setIconPressed(Drawable icon) {
    ...
    public ImageStateHelper setIconUnable(Drawable icon) {
    ...
    public ImageStateHelper setBorderWidth(int borderWidth) {
    ...
    public ImageStateHelper setBorderColor(@ColorInt int borderColor) {
    ...
    public ImageStateHelper setCorner(float corner) {
        this.mCorner = corner;
        init();
        invalidate();
        return this;
    ...
    public ImageStateHelper setCornerTopLeft(float cornerTopLeft) {
        this.mCorner = -1;
    ...
    public ImageStateHelper setCornerTopRight(float cornerTopRight) {
        this.mCorner = -1;
    ...
    public ImageStateHelper setCornerBottomLeft(float cornerBottomLeft) {
        this.mCorner = -1;
    ...
    public ImageStateHelper setCornerBottomRight(float cornerBottomRight) {
        this.mCorner = -1;
    ...
    public ImageStateHelper setCorner(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        this.mCorner = -1;
