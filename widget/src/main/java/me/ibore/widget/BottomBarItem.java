...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_bbItemTextSize, UIUtils.sp2px(getContext(), mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_bbItemMarginTop, UIUtils.dp2px(getContext(), mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_bbUnreadTextSize, UIUtils.sp2px(getContext(), mUnreadTextSize));
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_bbMsgTextSize, UIUtils.sp2px(getContext(), mMsgTextSize));
