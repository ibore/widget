...
import me.ibore.widget.wheel.SimpleWheelDecoration;
import me.ibore.widget.wheel.WheelDecoration;
import me.ibore.widget.wheel.WheelUtils;
import me.ibore.widget.wheel.WheelViewAdapter;
...
public class WheelView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            itemCount = a.getInt(R.styleable.WheelView_wvItemCount, itemCount);
            textColor = a.getColor(R.styleable.WheelView_wvTextColor, textColor);
            ...
            textSize = a.getDimension(R.styleable.WheelView_wvTextSize, textSize);
            itemSize = a.getDimensionPixelOffset(R.styleable.WheelView_wvItemSize, itemSize);
            dividerSize = a.getDimensionPixelOffset(R.styleable.WheelView_wvDividerSize, dividerSize);
            orientation = a.getInt(R.styleable.WheelView_wvOrientation, orientation);
            a.recycle();
        }
