...
public class WheelView<T> extends View implements Runnable {
    ...
    private void initAttrsAndDefault(Context context, AttributeSet attrs) {
        ...
        mVisibleItems = typedArray.getInt(R.styleable.WheelView_wvVisibleItems, DEFAULT_VISIBLE_ITEM);
        //跳转可见item为奇数
        mVisibleItems = adjustVisibleItems(mVisibleItems);
        mSelectedItemPosition = typedArray.getInt(R.styleable.WheelView_wvSelectedItemPosition, 0);
        //初始化滚动下标
        mCurrentScrollPosition = mSelectedItemPosition;
        isCyclic = typedArray.getBoolean(R.styleable.WheelView_wvCyclic, false);
        ...
        isCurved = typedArray.getBoolean(R.styleable.WheelView_wvCurved, true);
