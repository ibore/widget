...
public class VoiceLineView extends View {
    ...
    private void initAtts(Context context, AttributeSet attrs) {
        ...
        mode = typedArray.getInt(R.styleable.VoiceLineView_vlvViewMode, 0);
        voiceLineColor = typedArray.getColor(R.styleable.VoiceLineView_vlvVoiceLine, Color.BLACK);
        maxVolume = typedArray.getFloat(R.styleable.VoiceLineView_vlvMaxVolume, 100);
        sensibility = typedArray.getInt(R.styleable.VoiceLineView_vlvSensibility, 4);
        if (mode == RECT) {
            rectWidth = typedArray.getDimension(R.styleable.VoiceLineView_vlvRectWidth, 25);
            rectSpace = typedArray.getDimension(R.styleable.VoiceLineView_vlvRectSpace, 5);
            rectInitHeight = typedArray.getDimension(R.styleable.VoiceLineView_vlvRectInitHeight, 4);
        } else {
            middleLineColor = typedArray.getColor(R.styleable.VoiceLineView_vlvMiddleLine, Color.BLACK);
            middleLineHeight = typedArray.getDimension(R.styleable.VoiceLineView_vlvMiddleLineHeight, 4);
            lineSpeed = typedArray.getInt(R.styleable.VoiceLineView_vlvLineSpeed, 90);
            fineness = typedArray.getInt(R.styleable.VoiceLineView_vlvFineness, 1);
