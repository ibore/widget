...
import me.ibore.widget.adapter.TagAdapter;
...
public class TagLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    public TagLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectedMax = ta.getInt(R.styleable.TagLayout_tlMaxSelect, 0);
        ta.recycle();
    }
    ...
    public static class TagView extends FrameLayout implements Checkable {
