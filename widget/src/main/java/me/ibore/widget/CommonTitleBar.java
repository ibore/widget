...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_5 = UIUtils.dp2px(context, 5);
        PADDING_12 = UIUtils.dp2px(context, 12);
        ...
        titleBarHeight = (int) array.getDimension(R.styleable.CommonTitleBar_titleBarHeight, UIUtils.dp2px(context, 44));
        ...
        bottomShadowHeight = array.getDimension(R.styleable.CommonTitleBar_bottomShadowHeight, UIUtils.dp2px(context, 0));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, UIUtils.dp2px(context, 16));
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextSize = array.getDimension(R.styleable.CommonTitleBar_rightTextSize, UIUtils.dp2px(context, 16));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextSize = array.getDimension(R.styleable.CommonTitleBar_centerTextSize, UIUtils.dp2px(context, 18));
            ...
            centerSubTextSize = array.getDimension(R.styleable.CommonTitleBar_centerSubTextSize, UIUtils.dp2px(context, 11));
    ...
    private void initGlobalViews(Context context) {
        ...
        if (fillStatusBar && transparentStatusBar) {
            ...
            viewStatusBarFill.setId(UIUtils.generateViewId());
            viewStatusBarFill.setBackgroundColor(statusBarColor);
            RelativeLayout.LayoutParams statusBarParams = new LayoutParams(MATCH_PARENT, statusBarHeight);
        ...
        rlMain.setId(UIUtils.generateViewId());
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, UIUtils.dp2px(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, UIUtils.dp2px(context, 0.4f)));
            ...
            LayoutParams bottomShadowParams = new LayoutParams(MATCH_PARENT, UIUtils.dp2px(context, bottomShadowHeight));
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            tvLeft.setId(UIUtils.generateViewId());
            ...
            btnLeft.setId(UIUtils.generateViewId());
            ...
            if (viewCustomLeft.getId() == View.NO_ID) {
                viewCustomLeft.setId(UIUtils.generateViewId());
            }
    ...
    private void initMainRightViews(Context context) {
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            tvRight.setId(UIUtils.generateViewId());
            ...
            btnRight.setId(UIUtils.generateViewId());
            ...
            if (viewCustomRight.getId() == View.NO_ID) {
                viewCustomRight.setId(UIUtils.generateViewId());
            }
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            llMainCenter.setId(UIUtils.generateViewId());
            ...
            // 设置跑马灯效果
            tvCenter.setMaxWidth((int) (UIUtils.getScreenPixelSize(context)[0] * 3 / 5.0));
            ...
            int progressWidth = UIUtils.dp2px(context, 18);
            ...
            // 设置边距
            centerParams.topMargin = UIUtils.dp2px(context, 7);
            centerParams.bottomMargin = UIUtils.dp2px(context, 7);
            ...
            ivSearch.setId(UIUtils.generateViewId());
            ivSearch.setOnClickListener(this);
            int searchIconWidth = UIUtils.dp2px(context, 15);
            ...
            ivVoice.setId(UIUtils.generateViewId());
            ...
            etSearchHint.setHint(getResources().getString(R.string.widget_title_bar_search_hint));
            etSearchHint.setTextColor(Color.parseColor("#666666"));
            etSearchHint.setHintTextColor(Color.parseColor("#999999"));
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, UIUtils.dp2px(context, 14));
            ...
            if (centerCustomView.getId() == View.NO_ID) {
                centerCustomView.setId(UIUtils.generateViewId());
            }
...
//            }
    ...
    public void setLeftView(View leftView) {
        if (leftView.getId() == View.NO_ID) {
            leftView.setId(UIUtils.generateViewId());
        }
        LayoutParams leftInnerParams = new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        leftInnerParams.addRule(RelativeLayout.ALIGN_PARENT_START);
        leftInnerParams.addRule(RelativeLayout.CENTER_VERTICAL);
    ...
    public void setCenterView(View centerView) {
        if (centerView.getId() == View.NO_ID) {
            centerView.setId(UIUtils.generateViewId());
        }
    ...
    public void setRightView(View rightView) {
        if (rightView.getId() == View.NO_ID) {
            rightView.setId(UIUtils.generateViewId());
        }
        LayoutParams rightInnerParams = new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        rightInnerParams.addRule(RelativeLayout.ALIGN_PARENT_END);
        rightInnerParams.addRule(RelativeLayout.CENTER_VERTICAL);
    ...
    public void showSoftInputKeyboard(boolean show) {
        if (centerSearchEditable && show) {
            ...
            UIUtils.showSoftInputKeyBoard(getContext(), etSearchHint);
        } else {
            UIUtils.hideSoftInputKeyBoard(getContext(), etSearchHint);
        }
    }
