...
public class FlowLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mIsSingleLine = ta.getBoolean(R.styleable.FlowLayout_flSingleLine,false);
        mMaxLineNumbers = ta.getInteger(R.styleable.FlowLayout_flMaxLines, Integer.MAX_VALUE);
        mIsMultiChecked = ta.getBoolean(R.styleable.FlowLayout_flMultiChecked,false);
        mHorizontalSpace = ta.getDimension(R.styleable.FlowLayout_flHorizontalSpace,0);
        mVerticalSpace = ta.getDimension(R.styleable.FlowLayout_flVerticalSpace,0);
        mColumnNumbers = ta.getInteger(R.styleable.FlowLayout_flColumnNumbers,0);
        mRowNumbers = ta.getInteger(R.styleable.FlowLayout_flRowNumbers,0);
        mCutLineColor = ta.getColor(R.styleable.FlowLayout_flCutLineColor,getResources().getColor(android.R.color.darker_gray));
        mCutLineWidth = ta.getDimension(R.styleable.FlowLayout_flCutLineWidth,1f);
        mIsCutLine = ta.getBoolean(R.styleable.FlowLayout_flCutLine,false);
        mIsCenter = ta.getBoolean(R.styleable.FlowLayout_flLineCenter,false);
        if (mColumnNumbers != 0) {
            mIsGridMode = true;
        }
        ta.recycle();
